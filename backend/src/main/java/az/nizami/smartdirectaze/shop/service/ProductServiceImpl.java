...
class ProductServiceImpl implements ProductService {
    ...
    @Override
    @Transactional
    public ProductDTO updateProduct(Long shopId, Long productId, ProductDTO productDto, MultipartFile photo) {
    ...
    public void updateDeliveryConfig(Long shopId,
        ...
        shop.setTryingReturnsPolicy(tryingReturnsPolicy);
        shop.setWorkingHours(workingHours);
        shop.setAddress(address);
        shop.setPaymentMethodsJson(JsonUtil.toJson(paymentMethods));
