...
public interface BusinessMemberRepository extends JpaRepository<BusinessMember, UUID> {
    ...
    @Query("""
              select new az.nizami.smartdirectaze.business.dto.IndustrySummaryDto(
                b.industry,
                case
                  when b.industry = az.nizami.smartdirectaze.business.Industry.SHOP then 'Shop'
                  when b.industry = az.nizami.smartdirectaze.business.Industry.EVENTS then 'Events'
                  when b.industry = az.nizami.smartdirectaze.business.Industry.DENTAL then 'Dental'
